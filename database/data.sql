...
INSERT INTO "videos" ("userId", "likes", "caption", "videoUrl", "thumbnailUrl", "uploadedAt")
     VALUES (1, 0, 'The GOAT', '/videos/faker-azir.mp4','/videos/faker-azir.gif', NOW() + interval '1 week'),          --1
            (1, 5, 'FAKKKEEERRR', '/videos/faker-azir-1.mp4','/videos/faker-azir-1.gif', NOW() + interval '2 week'),   --2
            ...
            (1, 5, 'Weird', '/videos/faker-azir-8.mp4','/videos/faker-azir-8.gif', NOW() + interval '9 week');         --9
